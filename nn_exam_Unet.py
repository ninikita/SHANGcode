...
for run, seed in enumerate(seeds):
    ...
    opt_names = {
        'SHNAG': 'SHNAG(self.net.parameters(), alpha={} , time_scale={}, weight_decay={})'.format(0.5, 0.5, 1e-5),
        'ISHNAG': 'ISHNAG(self.net.parameters(), alpha={} , time_scale={}, rho = {}, weight_decay={})'.format(0.5, 0.5, 1.5, 1e-5),
